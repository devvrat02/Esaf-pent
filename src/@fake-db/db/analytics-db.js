...
mock.onGet('/api/analytics-app/widgets').reply(config => {
	return [200, analyticsAppDB.widgets];
});

mock.onGet('/api/analytics-app/projects').reply(config => {
	return [200, analyticsAppDB.projects];
});
export default analyticsAppDB